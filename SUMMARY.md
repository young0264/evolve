...
* [Redis(with Cache)](redis-with-cache/README.md)
  * [Intall(3ways)](redis-with-cache/intall-3ways/README.md)
    * [File Installation(Source)](redis-with-cache/intall-3ways/file-installation-source.md)
    * [Homebrew(MacOs)](redis-with-cache/intall-3ways/homebrew-macos.md)
    * [Docker](redis-with-cache/intall-3ways/docker.md)
  * [Caching Strategy](redis-with-cache/caching-strategy.md)
  * [Cache Eviction Policy](redis-with-cache/cache-eviction-policy.md)
* [Software Architecture](software-architecture/README.md)
  * [Architecture Pattern](software-architecture/architecture-pattern/README.md)
    * [CQS vs CQRS](software-architecture/architecture-pattern/cqs-vs-cqrs.md)
...
* [BOOK + STUDY](study-group/README.md)
  * [Redis: Hand-on Study](study-group/redis-hand-on-study/README.md)
    * [Practice: Redis Data Type Examples  (CLI)](study-group/redis-hand-on-study/practice-redis-data-type-examples-cli.md)
    * [Page 1](study-group/redis-hand-on-study/page-1.md)
  ...
  * [자바 성능 튜닝 이야기](study-group/undefined-2/README.md)
    * [int\[\] vs Integer\[\]](study-group/undefined-2/int-vs-integer.md)
    * [String vs StringBuilder vs StringBuffer](study-group/undefined-2/string-vs-stringbuilder-vs-stringbuffer.md)
    * [Collection, Map](study-group/undefined-2/collection-map.md)
  ...
  * [면접 스터디](study-group/undefined-3/README.md)
    * [Network](study-group/undefined-3/network/README.md)
      * [layer, protocol, http](study-group/undefined-3/network/layer-protocol-http.md)
    * [Database](study-group/undefined-3/database/README.md)
      * [what is database ?](study-group/undefined-3/database/what-is-database.md)
